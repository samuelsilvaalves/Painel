 ...
 *      Rev.:    V4.20 (Modificado para SMSC9720) 24/01/2014
 *----------------------------------------------------------------------------
...
//
//  printf("[Hardware ethernet...Wait]\r");
//  fflush(stdout);
//
...
//	if(!(tout % 5000))
//	{
//		printf("[%X...reg:%X]\r\r",tout,regv);
//  		fflush(stdout);
//	}
//  }
//
//  printf("[Hardware ethernet...OK...%X...%X]\r\r",tout,regv);
//  fflush(stdout);
//
//  /* Check if this is a DP83848C PHY. */
//  //id1 = read_PHY (PHY_REG_IDR1);	//teste de leitura do mac
//  //id2 = read_PHY (PHY_REG_IDR2);	//teste deleitura do mac
//
//  //printf("id1:%X...id2:%X\r\r",id1,id2);
//  //fflush(stdout);
//
//  //printf("passo5\r\r");
//  //fflush(stdout);
//
//  if (1/*((id1 << 16) | (id2 & 0xFFF0)) == DP83848C_ID*/) {
...
//    write_PHY (PHY_REG_BMCR, 0x1000/*PHY_AUTO_NEG*/);
//    /* Wait to complete Auto_Negotiation. */
//    for (tout = /*0x100000*/0x10000; tout; tout--) {
//      regv = read_PHY (PHY_REG_BMSR);
//      if (regv & 0x0020) 
//	  {
//	  		//printf("Autonegotiation Complete\r");
//			//fflush(stdout);
...
//		{
//      		/* Link is on. */
//			//printf("Link is on 2\r");
//			//fflush(stdout);
//      		break;
//    	}
//	}
//
//  //printf("Antes...SA0:%X...SA1:%X...SA2:%X\r\r",LPC_EMAC->SA0,LPC_EMAC->SA1,LPC_EMAC->SA2);
//  //fflush(stdout);
//
...
//
//  //printf("Depois...SA0:%X...SA1:%X...SA2:%X\r\r",LPC_EMAC->SA0,LPC_EMAC->SA1,LPC_EMAC->SA2);
//  //fflush(stdout);
//
