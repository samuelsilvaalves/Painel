...
void SystemInit (void)
{
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->FLASHCFG  = (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->FLASHCFG & ~0x0000F000) | 0x00004000;
	...
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &=~(1<<3); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= (1<<0); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= (1<<1); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= (1<<2); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR |= (1<<0); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR |= (1<<1); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR |= (1<<2);;
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<16); if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<16); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<16);;
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<28); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<27); if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<27); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<27);; if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<28); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<28);;;

	for(j=0;j<10000;j++)
		for(i=0;i<1000;i++);

	 
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDMOD = (1<<0)	| (1<<1);
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDTC = 0xFFFFFF;
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0xAA;
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0x55;

	
	((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD = (SystemFrequency / 100) - 1;	 
	

 	((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL = 0x05;
}
