...
#line 120 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
 ...
 TCP_INFO  tcp_socket[15+1];
 U8  const tcp_NumSocks  = 15;
 U8  const tcp_MaxRetry  = 5;
 U16 const tcp_RetryTout = 4 * (1000 / 100);
 U16 const tcp_2MSSTout  = (200 + 100 - 1) / 100;
 U16 const tcp_SynRetryTout = 2 * (1000 / 100);
 U16 const tcp_InitRetryTout= 1 * (1000 / 100);
 U16 const tcp_DefTout   = 120;
 U8  const tcp_ConRetry  = 7;
#line 159 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
 FTP_INFO  ftp_session[3];
 U8  const ftp_NumSess  = 3;
 U8  const ftp_EnAuth   = 1;
 U16 const ftp_PortNum  = 21;
 U8  const ftp_auth_user[]    = "admin";
 U8        ftp_auth_passw[20] = "";
#line 181 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
...
#line 201 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
  ...
  init_tcp ();
#line 221 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
  init_ftp ();
  ...
  init_dhcp ();
#line 240 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
}
...
#line 257 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
  ...
  tcp_poll_sockets ();
#line 274 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
  run_ftp_server ();


  run_dhcp_client ();
#line 288 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
}
...
#line 801 "src\\tcpip\\Net_Config.c"
