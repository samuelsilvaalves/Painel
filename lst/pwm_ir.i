...
#line 15 "src\\IR\\pwm_ir.c"



int PWM_freq_KHz = 657;
...
{
  	uint32_t regVal;
  	regVal = ((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->IR;
  	if ( regVal & (1 << 0) )	
		PWM_Set(PWM_freq_KHz);
  	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->IR |= regVal;				 
  	return;
}
...
void PWM_Init(void)
{
	...
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->TCR = 0x00000002;			   
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->PR  = 0x00;				  
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MCR = (1 << 0);			  				
	PWM_Set(657);		 
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->PCR = 0;
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->TCR = 0x00;				  

	for(i=0;i<3;i++)
		((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= (1<<i); 	 
	

	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN = 0x00;		 	 
...
void PWM_Set(uint32_t cycle)
{
	...
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR0 = cycle;	 
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR1 = cycle/2;		   
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR2 = cycle/2;  
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR3 = cycle/2; 
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR4 = cycle/2;  
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR5 = cycle/2;
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR6 = 0;
			  
	

  
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->LER = (1 << 0) | (1 << 1) | (1 << 2); 
}
...
void PWM_Start(char channel)
{
	...
	{	
		...
		((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1<<1);  
		((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 |=  (1<<0);
		((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->PCR |= (1 << 9);
		 
		((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1<<3); 
		((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 |=  (1<<2);
		((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->PCR |= (1 << 10);
		 
		((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1<<5); 
		((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 |=  (1<<4);
		((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->PCR |= (1 << 11);				
	...
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->TCR = 0x00000001 | 0x00000008;	 
}
...
{	
	...
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN 	&= ~(1<<0);
	...
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN 	&= ~(1<<1);
	...
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN 	&= ~(1<<2);
