...
#line 24 ".\\inc\\IR\\pwm_ir.h"





#line 36 ".\\inc\\IR\\pwm_ir.h"





#line 62 ".\\inc\\IR\\pwm_ir.h"

#line 74 ".\\inc\\IR\\pwm_ir.h"

#line 82 ".\\inc\\IR\\pwm_ir.h"


extern int PWM_freq_KHz;
...
#line 23 ".\\inc\\extint.h"
#line 24 ".\\inc\\extint.h"
...
void verify_last_reset(void)
{
	...
	if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->RSID & (1<<1))
		printf("[EXTR][Reset Extern]\r");
	if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->RSID & (1<<2))
		printf("[WDTR][Reset WDT]\r");
	if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->RSID & (1<<3))
		printf("[BODR][Reset Brown-Out Detector]\r\r");
	fflush((& __stdout));
	 
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->RSID &= ~(1<<0) | (1<<1) | (1<<2) | (1<<3);	
}
...
{		
	SystemInit();
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &=~(1<<11); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &=~(1<<12); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIODIR |= (1<<25); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIODIR |= (1<<26); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR |= (1<<18); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOSET |= (1<<25); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOSET |= (1<<26); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOSET |= (1<<18);; ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<16); if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<16); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<16);; ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<28); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<27); if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<27); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<27);; if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<28); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<28);;; ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &=~(1<<3); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= (1<<0); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= (1<<1); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= (1<<2); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR |= (1<<0); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR |= (1<<1); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR |= (1<<2);;; ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<6); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<15); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<5); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<4); if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<4); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<4);; if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<5); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<5);; if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<15); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<15);; if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<6); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<6);;;;
	init_uart();
	verify_last_reset();
	init_register();
	init_msd();	
