...
#line 9 "src\\register.c"

IR_STATE ir_state; 

unsigned int out_leds;		 				 
...
void init_register(void)
{
	U64 j;
	int i,y,num_rand=0;
	char seq[24] = {16,17,0,1,2,3,7,6,5,4,19,18,20,21,8,9,10,11,15,14,13,12,23,22}; 
	...
	out_leds = 0xFFFFFFFF;		 
	atualiza_saidas();
	if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<27); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<27);;
	if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<28); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<28);;
	for(j=0;j<6000000;j++);			
	out_leds = 0;				 
	atualiza_saidas();
	if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<27); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<27);;
	if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<28); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<28);;	
}
...
void atualiza_saidas(void)
{
	...
	for(i=24-1;i>=0;i--)	 
   	...
   	{
       	if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<15); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<15);; 							 
		...
		if(ir_state.bit.PwrPainel)		 
		{
			...
			if(touchEnaDis & (1<<i))
			{
				if((out_leds & (1<<i)))((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<5); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<5);;
			}else
				if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<5); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<5);;	 
		}else

			if(!(out_leds & (1<<i)))((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<5); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<5);;	
		if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<15); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<15);;   				 
	}
	...
	if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<4); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<4);; 	 
