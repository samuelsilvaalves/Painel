...
#line 29 "src\\extint.c"
#line 30 "src\\extint.c"
#line 1 ".\\inc\\touch.h"
...
char get_new_ir(void)
{
	...
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 2;	 
	...
	{	 			
		...
		if(status)	 
		{
			if(!((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<3))))	 	
			{
				if(!1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOSET |= (1<<18); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOCLR |= (1<<18);; 	
				if(logic)	
				{
					logic = 0;
					pulse++;  
			...
			{
				if(!0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOSET |= (1<<18); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOCLR |= (1<<18);; 	
				if(!logic)
				{
					logic = 1;
					pulse++;  
			...
			ir[pulse] = ((ir[pulse] == 0xFFFF) ? 0 : ir[pulse]) + ir_counter;	 
			ir_counter = 0;											 
			if(ir[pulse] * 4 >= 120000)  
			{	
				ir[pulse] = 0xFFFF;  
				status = 0;	 	
			}
	...
	{		
		...
		for(x=0;x<NUM_SCENE;x++)	 
		{
			((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0xAA; ((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0x55;;
			memset(ir,0xFFFF,sizeof(ir));
			memset(strId,0,sizeof(strId));
			sprintf(strId,"%s%u.TXT\0","CMDIR\\IR_\0",x);
...
void ext_task(void)
{
	...
	if(!atoi(cfg.file.func_ir_scene))	 
	{
...
void EINT3_IRQHandler (void) 
{
	...
	((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntClr |= (1 << 3);     
	flag_new_cmdir = 1;
...
uint32_t Init_EINT (void)
{
#line 388 "src\\extint.c"

    
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &= ~(1<<3);        	 
	((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntEnF |= (1<<3);       
	NVIC_EnableIRQ(EINT3_IRQn);              
#line 402 "src\\extint.c"
  	return 1;
}
