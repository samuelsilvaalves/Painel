...
int debounce_press = 500;
int debounce_release = 8000;

char temp_ar = 16;

char aux_scene[30];					 
char current_scene[30];				 
char current_id_scene=7;
char scene[NUM_SCENE][30];			 
char touch_led_press = 0xFF;	 
...
char save_scene(char *_scene,char addr)
{
	...
	sprintf(str,"%s%u.TXT\0","DIMMER\\SCENE_\0",addr);
	f = fopen(str,"w");
...
void init_scene(char modo)
{
	...
	for(i=start; i<end; i++)	 
	{
		...
		if(read_scene(i,"DIMMER\\SCENE_\0"))			 
		{
			 	
			strcpy(scene[i],aux_scene);				 
		...
		}else
		{
			...
			if(i == 0) strcpy(scene[i],"SET 100100100111\0");		 
			else if(i == 1) strcpy(scene[i],"SET 060060060000\0");	 
			else if(i == 2) strcpy(scene[i],"SET 010010010111\0");	 
			else if(i == 3) strcpy(scene[i],"SET 000000000000\0");	 
...
void exe_scene(char num_scene)
{
	...
	if(scene[num_scene][0] != 0)					 
	{
		current_id_scene = num_scene;				 		
		strcpy(current_scene,scene[num_scene]);		         					
...
void init_touch(void)
{
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR |= (1ul<<31ul);
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR |= (1<<30ul);
	
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR &=~(1<<25);
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR &=~(1<<23);
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR &=~(1<<26);
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR &=~(1<<24);
...
char read_touch(void)
{
	...
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOSET |= (1ul<<31ul); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOSET |= (1<<30ul);
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOCLR |= (1ul<<31ul);
	for(i=0;i<0xFF;i++);
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0xAA; ((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0x55;;

	if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN & (1<<25)))
		return num16;

	if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN & (1<<23)))
		return num18;

	if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN & (1<<26)))
		return num20;

	if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN & (1<<24)))
		return num22;

	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOSET |= (1ul<<31ul); ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOSET |= (1<<30ul);
	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOCLR |= (1<<30ul);
	for(i=0;i<0xFF;i++);
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0xAA; ((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0x55;;
...
void touch_task(void)
{
	char key, str_IdIr[4], str_aux[100], flag_send_ir = 0;	
	U32 i;
...
void beep(char modo)
{
	...
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0xAA; ((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0x55;;
	if(1)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<16); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<16);;
	if(modo == BEEP_CFG)
	{
		for(i=0;i<4;i++)
		{
			for(j=0;j<500000;j++);
			if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN & (1<<16)))((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<16); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<16);;
		}	
	}else
	if(modo == BEEP_PULSO) 
		for(j=0;j<300000;j++);
	...
	{ 
		for(i=0;i<6;i++)
		{
			...
			for(j=0;j<6000000;j++);
			if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN & (1<<16)))((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<16); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<16);;
			if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN & (1<<27)))((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<27); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<27);;
		}
	}else
	if(modo == BEEP_ERROR) 
		for(j=0;j<3000000;j++);
	...
	((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0xAA; ((LPC_WDT_TypeDef *) ((0x40000000UL) + 0x00000) )->WDFEED = 0x55;;
	if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<16); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<16);;
}
...
void key_task(void)
{
	...
	if(!((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<11))))
	{
		if(++cnt_deb < 5)
			return;
		...
		if(!(++cnt_led % 3))
		{
			if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOPIN & (1<<26)))((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOSET |= (1<<26); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOCLR |= (1<<26);;
			if(!(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN & (1<<27)))((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<27); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<27);;		
		}	
	...
	}else
	{
		cnt_buz = 0;
		cnt_deb = 0;
		if(!0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOSET |= (1<<26); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOCLR |= (1<<26);;
		if(0)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET |= (1<<27); else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR |= (1<<27);;		
	}
}
